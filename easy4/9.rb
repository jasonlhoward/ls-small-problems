...
# this the old-fashioned way and construct the string by analyzing
...
def integer_to_string(int)
  ...
  power = 0
  loop do
    break if int / 10**power < 10
    power += 1
  end
  loop do
    chars << NUMBER_MAP[int / 10**power]
    break if power.zero?
...
p integer_to_string(43_214_321_432_143_214_321) == '43214321432143214321'
